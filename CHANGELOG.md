...
- The proposed `understand-codebase` skill was abandoned at its Tier-2 opportunity gate: baseline and strongest-prompt arms both passed all 10 critical mapping checks, so the cheaper prompt remains the supported mechanism.
